...
public class Creat2 {
	//MICROSOFT EDGE: Add new assignment accept File submission => OK
	public static void main(String[] args) {
		...
		WebElement addAssignment = wait8.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[.//img[@src='https://school.moodledemo.net/theme/image.php/boost/assign/1715014895/monologo']]")));
		addAssignment.click();
